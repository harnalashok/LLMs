...
llm = Ollama(model= "mistral:latest", #             "qwen3.5:cloud", 
...
embed_model = OllamaEmbedding(
    				            model_name="nomic-embed-text",     # Or use mxbai-embed-large
    				            base_url="http://localhost:11434",
			                )
...
#    Information about Foreign Keys are absent. Should have been included.
