...
if [ ! -f /home/$USER/cuda_installed.txt ]; then
	...
	wget -c https://developer.download.nvidia.com/compute/cuda/repos/wsl-ubuntu/x86_64/cuda-wsl-ubuntu.pin
...
if [ ! -f /home/$USER/ollama_installed.txt ]; then
	...
	wget -c https://github.com/harnalashok/LLMs/blob/main/install_ai_tools/misc/Types_of_LLMs.pdf
...
if [ ! -f /home/$USER/langchain_installed.txt ]; then
	...
	python3.11 -m venv /home/$USER/langchain
