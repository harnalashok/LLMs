...
if [ ! -f /home/$USER/first_time.txt ]; then
	...
	echo "Will download a few lightweight ollama models"
	echo "Will install langchain and llamaindex"
	...
	echo "Installs postgres, sqlite3 and pgvector"
...
if [ ! -f /home/$USER/vectordb_installed.txt ]; then
    ...
    if [ ! -f /home/$USER/postgresql_installed.txt ]; then
		...
		# Install postgresql server and sqlite3
		echo "   "
		echo "------------"     
...
if [ ! -f /home/$USER/models_installed.txt ]; then
	 echo "------------"   
	  ...
	  echo "15. Pulling alibayram/smollm3"
	  docker exec -it ollama ollama pull alibayram/smollm3
	  echo "16. Pulling smollm2"
	  docker exec -it ollama ollama pull smollm2
	  echo "17. Pulling granite4.1:3b"
	  docker exec -it ollama ollama pull granite4.1:3b
	  echo "18. Pulling mistral:latest"
	  docker exec -it ollama ollama pull mistral:latest
	  echo "19. Pulling granite-embedding"
