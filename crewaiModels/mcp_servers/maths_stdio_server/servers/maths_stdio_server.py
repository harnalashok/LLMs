...
# 2.1 FastMCP natively uses Pydantic under the hood.
#      When you decorate a function with @mcp.tool(), 
#       FastMCP automatically:Generates an input schema
#         based on your function's parameters and type annotations.
@mcp.tool()
